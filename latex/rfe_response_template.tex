...
\addlinespace[0.2em]
\textbf{Structure-specific operational extension} & \textbf{Nanyang Technological University, Singapore --- Zhuo et al. (2023), \ExhibitRef{5D-4}.} Extended my cooperative roundabout control framework to CAV platooning configuration research, applying the same structure-specific mixed-traffic interaction problem I addressed to evaluate platoon size, platoon willingness, and throughput/delay tradeoffs at isolated roundabouts. \\
\addlinespace[0.2em]
