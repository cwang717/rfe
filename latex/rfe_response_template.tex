...
\addlinespace[0.2em]
\textbf{National-laboratory technical extension} & \textbf{Oak Ridge National Laboratory --- Zhou et al. (2024), \ExhibitRef{5D-3}.} Extended my proactive longitudinal control and disruptive lane-change management methods into later learning-based car-following control research involving behavior cloning, deep reinforcement learning, and mixed-traffic generalizability under stop-and-go conditions. \\
\addlinespace[0.2em]
