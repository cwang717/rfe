...
3. Dr. Wang developed control, planning, and learning-based methods that help autonomous vehicles move more safely and efficiently in mixed traffic.

A key theme should be that autonomous driving is not a purely academic field. Progress requires coordination among academia, industry, and government:

* Academia develops theories, methods, and research questions.
* Industry provides deployment experience, real vehicle constraints, data limitations, and commercialization realities.
* Government needs technical knowledge for safety, infrastructure, regulation, and workforce training.
...
## Section 1. Introduction and Summary of the RFE Response
...
* USCIS has already accepted the authorship criterion.
* USCIS has already accepted the judging criterion.
...
Keep this section concise and respectful. Do not re-argue authorship or judging in detail.

---

## Section 2. Roadmap of the Original Contributions

### Purpose

Give the officer a simple, plain-English map before technical details.
...
Make the table concrete once evidence is available. For each cross-sector item, include:
...
## Section 3. Clarification: Publications Are Not the Contributions Themselves
...
State that Dr. Wang does not claim that publication alone establishes original contributions. Her publications disclosed the contributions, but the contributions themselves are the data, findings, models, methods, and benchmarks later used by others.
...
# Section 4. Contribution 1: Dr. Wang Produced Real-World Evidence Showing How Human Drivers Behave Around Autonomous Vehicles
...
* Dr. Wang generated controlled empirical data for human-driver behavior around autonomous vehicles.
* She identified how AV appearance or recognizability affects human-driver behavioral adaptation.
...
* Her author position on the relevant paper.
* Her role in experiment design, data generation, analysis, and interpretation.
* Coauthor statement confirming her specific contributions.
* Dataset documentation or experiment materials showing her role.
* Any evidence showing that later academic/industry collaborators specifically sought her input because of this mixed-traffic and real-world AV expertise.
...
| Coauthor confirmation                             | Confirms her specific role rather than attributing the work only to the team                                                                  | Insert exhibit |
| Industry support to NSF / academic project        | Provided industry-side support, deployment perspective, or real-world implementation input connected to mixed traffic or human-AV interaction | Insert exhibit |

## D. Objective Evidence of Adoption, Use, or Reliance

This subsection is essential. Do not merely list citations. Explain how each user used the contribution.
...
This should be included inside Contribution 1, not as a standalone contribution.
...
* Statement from PI explaining why her industry input was needed;
* Evidence that the work relates to mixed traffic, human-AV interaction, real-world deployment, data, evaluation, or validation.
...
Use expert letters only after the objective evidence. The letters should explain why the objective evidence matters.

Use:

* Jianming Ma for policy/regulatory significance.
* Yang Zhou for the field-experiment gap and benchmark significance.
* PI or organizer letter for NSF/academic project support.
* Amir Ghiasi only if the full recommendation letter or objective implementation evidence is available.

---

# Section 5. Contribution 2: Dr. Wang Created a More Realistic Model for Predicting and Simulating Human Driving Behavior
...
* Dr. Wang formulated a generalized stochastic framework for car-following behavior.
* The framework accounted for uncertainty and human-driver variation.
...
* First-author or leading-author evidence.
* Coauthor statement.
* Paper excerpts showing the framework/model.
* Any code, formula, or methodology evidence if available.
* Evidence showing her role in translating this modeling/simulation expertise to government-facing training.
...
| Wisconsin DOT-facing internal training  | Served as the only industry representative and provided modeling, simulation, AV behavior, or deployment insight to government-side transportation professionals | Insert exhibit |
...
## E. Wisconsin DOT-Facing Internal Training as Practical Translation Evidence

This should be included inside Contribution 2 if the training topic relates to modeling, simulation, AV behavior, safety evaluation, data needs, or government knowledge update.
...
* Slides or topic outline;
* Recording, transcript, minutes, or follow-up emails if available.

### Organizer Letter Should State

The organizer letter should not merely praise Dr. Wang. It should explain:

* The purpose of the training;
* Why DOT-facing participants needed the training;
* Why Dr. Wang was invited;
* That she was the only industry representative, if accurate;
* What specific topics she covered;
* How her industry perspective helped participants understand real-world AV behavior, modeling, simulation, safety, deployment constraints, or data needs;
* Whether her input helped update government-side technical knowledge.
...
# Section 6. Contribution 3: Dr. Wang Developed Methods That Help Autonomous Vehicles Plan Safer and More Efficient Movement in Mixed Traffic
...
* Dr. Wang developed trajectory-control and reinforcement-learning methods for mixed traffic.
* Her work addressed safety, efficiency, fuel consumption, comfort, and practical reliability.
* Her methods helped move the field beyond unrealistic mathematical assumptions.
...
* Author-role evidence for trajectory optimization/RL papers.
* Coauthor confirmation.
* Patent inventor records.
* Employer or manager statement if available.
* Evidence showing her role in method development, algorithm design, benchmarking, prediction, planning, or implementation.
* Evidence showing her role in the multi-stakeholder panel as the only AV industry practitioner, if accurate.
...
| Patent records                                       | Named inventor on AV prediction/planning/learning inventions                                                                            | Insert exhibit |
| Multi-stakeholder panel                              | Served as the only autonomous-driving industry practitioner and provided real-world deployment, planning, safety, or validation insight | Insert exhibit |
...
This should be included inside Contribution 3 if the panel topic relates to planning, prediction, deployment, AV safety validation, testing, industry constraints, or commercialization.
...
* Organizer letter;
* Panel description;
* Slides, notes, recording, transcript, or follow-up emails;
* Audience description showing academia/government/industry participation.

### Organizer Letter Should State

The organizer letter should explain:

* The purpose of the panel;
* The stakeholder groups represented;
* Why Dr. Wang was invited;
* That she was the only AV industry practitioner, if accurate;
* What specific topics she addressed;
* What unique industry perspective she provided;
* Why that perspective could not be easily supplied by purely academic participants;
* How her input helped the panel understand real-world AV deployment, testing, prediction, planning, safety validation, or industry constraints.
...
Use patents as corroborating evidence, not as the sole proof of major significance.

Suggested wording:

Dr. Wang does not rely on patents alone to establish the original-contributions criterion. Rather, her granted U.S. patents corroborate that her research expertise has continued to translate into practical autonomous-vehicle prediction, planning, and learning systems. These patents support the broader record showing that her contributions are not confined to academic publications but extend into implementable AV technologies.

## G. Why This Shows Major Significance
...
* Pawel Gora for reinforcement learning, benchmark, and commercial-technology comparison.
* Jianming Ma for CARMA/FHWA and traffic operations significance.
* Multi-stakeholder panel organizer letter for cross-sector reliance.
* Amir Ghiasi if a full letter or objective implementation evidence is available.
...
This section should not replace the three contribution sections. It should synthesize the evidence that appears within Contributions 1-3 and explain why this pattern is particularly important in autonomous driving.

## Central Argument

In autonomous driving, major technical progress does not occur through academic publication alone. The field requires continuous interaction among:

* Academic researchers who develop theories and methods;
...
### A. Industry support to NSF / academic project

Tie to Contribution 1:

* Shows academic researchers relied on her industry and real-world AV perspective.
* Supports the practical relevance of her mixed-traffic and human-AV interaction expertise.

### B. Wisconsin DOT-facing internal training

Tie to Contribution 2:

* Shows government-side transportation professionals sought her expertise for knowledge update and training.
* Supports the practical relevance of her modeling/simulation and AV behavior expertise.

### C. Multi-stakeholder panel

Tie to Contribution 3:

* Shows her AV planning/control/deployment expertise was sought in a setting involving multiple stakeholder groups.
* Supports the practical relevance of her industry experience and technical leadership.

### D. Continued academic-industry connection

Include:

* Continued publications after entering industry;
* Patents;
* Lead Autonomy Engineer role;
* Advisory board or review service;
* Dataset/leaderboard evidence if available.
...
# Section 9. Final Merits Determination

## Purpose

Show that the total record demonstrates sustained acclaim and that Dr. Wang is among the small percentage at the top of the field.

## Structure

### A. USCIS has already accepted two criteria

* Authorship;
* Judging.

### B. The response establishes a third criterion

* Original contributions of major significance.

### C. The evidence shows sustained acclaim and top-level recognition
...
* Substantive adoption by independent researchers;
* Government-facing training and knowledge transfer;
* Industry support to academic/NSF work;
* Multi-stakeholder panel role as the only AV industry practitioner;
* Government-related use;
* Industry-facing use;
* Patents;
* Advisory/panel roles;
* Expert recognition;
* Current role as Lead Autonomy Engineer.
...
* USCIS has accepted authorship and judging.
* The response establishes original contributions of major significance.
* The evidence shows originality, personal attribution, objective adoption, and major significance.
* The totality of the record satisfies final merits.
...
# Required Internal Structure for Each Contribution Section
...
## D. Objective Evidence of Adoption, Use, Reliance, or Cross-Sector Translation

Table showing who used the contribution, how they used it, and why that use matters.

## E. Practical Translation Evidence

For this case, include:

* Contribution 1: industry support to NSF / academic project.
* Contribution 2: Wisconsin DOT-facing internal training.
* Contribution 3: multi-stakeholder panel.

## F. Why This Shows Major Significance

Mini-conclusion connecting adoption and cross-sector use to field-level significance.

## G. Supporting Expert Explanation

Expert letters explain the objective evidence; they do not replace it.

---

# Evidence Checklist for the New Cross-Sector Items
...
* Evidence that Dr. Wang was the only industry representative;
* Topic outline;
* Follow-up emails, feedback, transcript, or recording if available.

Organizer letter should explain:

* Purpose of the training;
* Why Dr. Wang was invited;
* Her unique industry perspective;
* What specific topics she covered;
* How the training helped DOT-facing participants understand AV behavior, simulation, modeling, safety, or deployment.
...
* Organizer letter;
* Evidence that Dr. Wang was the only AV industry practitioner;
* Slides, notes, transcript, or recording;
* Audience description;
* Follow-up requests or emails.
...
# Recommended Exhibit Strategy

## Exhibit Group A: Accepted Criteria

* Authorship evidence;
* Judging/reviewer evidence.

## Exhibit Group B: Personal Attribution

* Coauthor statements;
* Author contribution evidence;
* Patent inventor records;
* Employment or manager statements;
* NSF/project role confirmation;
* Panel/training role confirmation.

## Exhibit Group C: Contribution 1 Evidence

* Field experiment paper;
* Dataset/public release evidence;
* Citation-context excerpts;
* AMS/FHWA/CUTR use evidence;
* T-intersection extension evidence;
* NSF/academic project support evidence;
* Expert explanation.

## Exhibit Group D: Contribution 2 Evidence

* Stochastic car-following model paper;
* Citation-context excerpts;
* Independent researcher adoption evidence;
* Wisconsin DOT-facing internal training evidence;
* Expert explanation.

## Exhibit Group E: Contribution 3 Evidence

* Trajectory optimization/RL papers;
* FHWA/CARMA/Leidos evidence;
* Benchmark evidence;
* Multi-stakeholder panel evidence;
* Patents;
* Expert explanation.

## Exhibit Group F: Cross-Cutting / Final Merits Evidence

* Granted patents;
* Current employment evidence;
* Advisory board evidence;
* Continued publication evidence after entering industry;
* Dataset/leaderboard evidence if available;
...
* Mixed traffic: roads where autonomous vehicles and human-driven vehicles operate together.
* Car-following model: a model that predicts how one vehicle follows another.
* Stochastic: accounting for uncertainty and variation.
* Trajectory optimization: choosing vehicle speed and path to improve safety, travel time, fuel use, or comfort.
* Benchmark: a reference method or dataset used by others to test their own systems.

## 3. Use evidence verbs
...
* used her industry-grounded insight;
* invited her to train government-side professionals.

Avoid unsupported:

* revolutionized;
* transformed the entire field;
* became a standard;
* was adopted by all major companies;
* changed regulation;
* commercialized by companies;
...
Each expert, organizer, or PI letter should be paired with objective evidence:

* public report;
* citation-context excerpt;
* patent record;
